...
junit:1.24 jacoco:3.0.1 gradle:1.28 gitlab-plugin:1.5.3 github-branch-source:2.3.2 \
...
role-strategy:2.7.0 sonar:2.6.1 kubernetes:1.3.1 hipchat:2.1.1 notification:1.12
