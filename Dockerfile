FROM jenkinsci/jenkins:2.107

LABEL maintainer="Eddú Meléndez" \
      jenkins.version="2.107"

RUN /usr/local/bin/install-plugins.sh blueocean:1.4.1 slack:2.3 pipeline-model-definition:1.2.7 \
junit:1.24 jacoco:2.2.1 gradle:1.28 gitlab-plugin:1.5.3 github-branch-source:2.3.2 \
...
role-strategy:2.7.0 sonar:2.6.1 kubernetes:1.2 hipchat:2.1.1 notification:1.12
