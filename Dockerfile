...
junit:1.21 jacoco:2.2.1 gradle:1.28 gitlab-plugin:1.4.8 github-branch-source:2.2.4 \
...
cloudbees-bitbucket-branch-source:2.2.4 checkstyle:3.49 disk-usage:0.28 findbugs:4.71 \
