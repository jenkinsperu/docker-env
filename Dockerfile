FROM jenkinsci/jenkins:2.114

LABEL maintainer="Eddú Meléndez" \
      jenkins.version="2.114"

RUN /usr/local/bin/install-plugins.sh blueocean:1.4.2 slack:2.3 pipeline-model-definition:1.2.8 \
...
role-strategy:2.7.0 sonar:2.6.1 kubernetes:1.5 hipchat:2.1.1 notification:1.13
