FROM jenkinsci/jenkins:2.93

LABEL maintainer="Eddú Meléndez" \
      jenkins.version="2.93"

RUN /usr/local/bin/install-plugins.sh blueocean:1.3.4 slack:2.3 pipeline-model-definition:1.2.5 \
junit:1.23 jacoco:2.2.1 gradle:1.28 gitlab-plugin:1.5.2 github-branch-source:2.3.1 \
