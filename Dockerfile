...
RUN /usr/local/bin/install-plugins.sh blueocean:1.2.1 slack:2.3 pipeline-model-definition:1.1.9 \
...
role-strategy:2.6.0 sonar:2.6.1 kubernetes:1.0 hipchat:2.1.1 notification:1.12
