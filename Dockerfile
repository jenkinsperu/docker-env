...
RUN /usr/local/bin/install-plugins.sh blueocean:1.1.1 slack:2.2 pipeline-model-definition:1.1.6 \
junit:1.20 jacoco:2.2.1 gradle:1.26 gitlab-plugin:1.4.5 github-branch-source:2.0.6 \
...
cloudbees-folder:6.0.4 github-organization-folder:1.6 matrix-auth:1.6 matrix-project:1.11 \
